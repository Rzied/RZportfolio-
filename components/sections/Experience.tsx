...
const experiences = [
  ...
  },
  {
    ...
    achievements: [
      'Mise en place d’une plateforme e-commerce B2B / B2C pour des clients grands comptes', 'Intégration et configuration d’un moteur de recherche interne basé sur Elasticsearch',
      'Intégration et configuration d’un moteur de recherche interne basé sur Elasticsearch',
      'Optimisation des performances front-end et back-end (temps de chargement, requêtes, indexation)',
      'Amélioration de la pertinence des résultats de recherche et de la navigation utilisateur',
    ],
    technologies: ['JavaScript', 'Elasticsearch', 'Front-end & Back-end web', 'APIs', 'Git', 'Docker', 'Vue.js', 'Node.js'],
  },
  {
    ...
    period: '2007 - 2019',
    location: 'Tunisie',
    description: 'Technicien informatique en charge de l’installation, de la maintenance et du support des systèmes informatiques pour des clients professionnels et particuliers. Intervention sur des environnements variés, avec une forte dimension terrain, support utilisateur et réseau.',
    achievements: [
      'Installation, configuration et maintenance de matériel informatique et logiciels',
      'Diagnostic et résolution d’incidents techniques(hardware, software, systèmes)',
      'Mise en place et configuration de réseaux informatiques(postes, imprimantes, périphériques)',
      'Assistance technique auprès des utilisateurs et accompagnement au quotidien',
      'Formation des utilisateurs aux outils informatiques et bonnes pratiques',
    ],
    technologies: ['Windows', 'Matériel informatique & périphériques', 'Réseaux(LAN, câblage, configuration)', 'Support technique'],
  },
]
