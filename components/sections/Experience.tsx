...
const experiences = [
  ...
  },
  {
    ...
    type: 'CDI',
    description: 'Développement et maintenance de robots RPA pour un client bancaire majeur. Automatisation des processus de traitement des données et des flux inter-systèmes.',
    achievements: [
      'Automatisation de 15+ processus métier',
      'Réduction de 70% du temps de traitement',
      'Développement de framework réutilisable',
      'Documentation et formation des équipes métier',
    ],
    technologies: ['UiPath', 'SQL', 'PL/SQL', 'Oracle', 'Git'],
  },
  {
    title: 'RPA Developer',
    company: 'Devoteam',
